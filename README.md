...
| --- | --- | --- |
| [`agent-toolkit`](https://github.com/zebadee2kk/agent-toolkit) | Reusable agent tooling, skills, templates and workflow components for controlled AI-assisted delivery. | Canonical internal toolkit |
| [`HamOS`](https://github.com/zebadee2kk/HamOS) | Secure-by-design personal operating environment for AI tooling, project coordination, sandboxing and data workflows. | Canonical internal platform |
| [`hamnet`](https://github.com/zebadee2kk/hamnet) | Home and VPS infrastructure lab covering hosting operations, network management and infrastructure automation. | Canonical internal infrastructure |
| [`portfolio-management`](https://github.com/zebadee2kk/portfolio-management) | GitHub estate governance, repo lifecycle evidence, prioritisation and consolidation control. | Canonical governance repo |
| [`best-practice-repo-template`](https://github.com/zebadee2kk/best-practice-repo-template) | Public template for secure, maintainable repositories with clear governance and delivery standards. | Public reference/template |
| [`control-tower`](https://github.com/zebadee2kk/control-tower) | Public reference for a GitHub-native control plane for AI-assisted project work. | Public reference |
| [`ai-powertools`](https://github.com/zebadee2kk/ai-powertools) | Public collection of workflow accelerators and AI-assisted development utilities. | Public reference |
| [`ai-cost-tracker`](https://github.com/zebadee2kk/ai-cost-tracker) | Public reference for AI usage cost tracking and budget visibility across model providers. | Public reference |
...
## Consulting and business alignment
...
For commercial context, see [richardham.co.uk](https://richardham.co.uk).
...
- Website: [https://richardham.co.uk](https://richardham.co.uk)
- LinkedIn: [https://uk.linkedin.com/in/hamrichard](https://uk.linkedin.com/in/hamrichard)
- GitHub: [https://github.com/zebadee2kk](https://github.com/zebadee2kk)
